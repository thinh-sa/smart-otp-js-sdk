...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SmartOtpSdk.OcraApi = factory(root.SmartOtpSdk.ApiClient, root.SmartOtpSdk.InlineResponse200);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.generateOtpOcra = function(pin, challenge, callback) {
      var postBody = null;

      // verify the required parameter 'pin' is set
      if (pin === undefined || pin === null) {
        throw new Error("Missing the required parameter 'pin' when calling generateOtpOcra");
      }

      // verify the required parameter 'challenge' is set
      if (challenge === undefined || challenge === null) {
        throw new Error("Missing the required parameter 'challenge' when calling generateOtpOcra");
      }
