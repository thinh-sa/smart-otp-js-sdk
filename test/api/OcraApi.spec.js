...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartOtpSdk.OcraApi();
  });

  describe('(package)', function() {
    describe('OcraApi', function() {
      describe('generateOtpOcra', function() {
        it('should call generateOtpOcra successfully', function(done) {
          // TODO: uncomment, update parameter values for generateOtpOcra call and complete the assertions
          /*
          var pin = "pin_example";
          var challenge = "challenge_example";

          instance.generateOtpOcra(pin, challenge, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
